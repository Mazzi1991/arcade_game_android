...
def process_boss_square(image_path, output_path):
    try:
        ...
        if bbox:
            ...
            print("Successfully processed and saved the square boss sprite!")
        else:
...
if __name__ == "__main__":
    process_boss_square("boss_square_raw.png", "boss_square.png")
